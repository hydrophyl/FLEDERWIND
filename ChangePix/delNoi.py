...
for indexofImage in range(100): # the first 100 images is taken to analyse the noise (noise appear in the same spot > 1 times in 100 images)
...
#TODO Translate RGB colors to HSV colors to better tracking algorithms
